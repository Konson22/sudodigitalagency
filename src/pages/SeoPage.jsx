...
export default function SeoPage() {
  return (
    <div>
      <PageHeader
        title={servicesInfo[4].title}
        text={servicesInfo[4].slogan}
        image={process.env.PUBLIC_URL + "/images/seo2.png"}
        bg="bg-sky-600"
      />

      <div className="bg-white md:mx-[15%] p-8">
        <p className="md:px-[15%] text-center">
          We focus on creating intuitive, responsive, and aesthetically pleasing
          websites that represent your brand's essence. Whether you need a
          simple informational site, an e-commerce platform, or a complex web
